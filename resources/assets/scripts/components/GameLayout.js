    ...
    return (
        <div style={{height:height, width: width}}>
            ...
            <div className="grid grid-cols-12 overflow-y-auto w-screen" style={{height:height*0.875}}>
                ...
                <div className=" col-span-2 flex flex-col bg-gray-700 border-2 border-red-700 space-y-2 rounded">
                    {rightMenu}
                </div>
            </div>

            <div className='flex bg-gray-700 border-2 border-red-700 py-3 w-screen px-2 space-x-2' style={{height:height*0.125}}>
                {bottomMenu}
            </div>
        </div>
    )
